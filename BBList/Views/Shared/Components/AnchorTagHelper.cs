...
namespace BBList.Views.Shared.Components
{
    ...
    public class AnchorTagHelper : TagHelper
    {
        ...
        public AnchorType Variant { get; set; }
        public AnchorSize Size { get; set; }
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            output.TagName = "a";

            string classString = "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-red-500 dark:aria-invalid:border-red-500/50 rounded-lg border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-3 aria-invalid:ring-3 [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none";
            ...
            switch (Variant)
            {
                ...
                case AnchorType.Outline:
                    classString += " border-zinc-300 bg-transparent hover:bg-transparent hover:text-foreground dark:bg-input/30 dark:border-zinc-300 dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground";
                    break;
                ...
                case AnchorType.Link:
                    classString += " text-slate-700 underline-offset-4 hover:underline";
                    break;
            }
